public class Zodiaco
{
    ...
    void signoZodiaco()
    {
        switch(mes)
        {
            ...
            case 7:
            nombre = (dia <= 23) ? "Cáncer" : "Leo";
            break;

            case 8:
            nombre = (dia <= 23) ? "Leo" : "Virgo";
            break;

            case 9:
            nombre = (dia <= 23) ? "Virgo" : "Libra";
            break;

            case 10:
            nombre = (dia <= 23) ? "Libra" : "Escorpio";
            break;

            case 11:
            nombre = (dia <= 22) ? "Escorpio" : "Sagitario";
            break;

            case 12:
            nombre = (dia <= 21) ? "Sagitario" : "Capricornio";
            break;
