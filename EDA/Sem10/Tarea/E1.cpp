...
int altura_arbol(NodoArbol * a)
{
    if(a == NULL)
        ...
        return 1 + maximo_entre_2(altura_arbol(a->izq),altura_arbol(a->der));
}
...
int main()
{
    ...
    cout << "La altura del arbol es: " << altura_arbol(a) << endl;
    cout << "El mayor valor del arbol es: " << arbol_mayor(a) << endl;
    cout << "Los valores de menor a mayor son: " << endl;
    imprime_creciente(a);
    cout << endl;
    cout << "La suma de todos los nodos es: " << suma(a) << endl;
    return 0;
}